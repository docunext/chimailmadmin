...
# RailsAdmin config file. Generated on October 15, 2011 13:37
...
RailsAdmin.config do |config|
  ...
  config.main_app_name { ['Chimailmadmin', 'Admin'] } # auto-generated
  ...
  # config.excluded_models << [Alias, Domain, Email, Server]

  # Add models here if you want to go 'whitelist mode':
  # config.included_models << [Alias, Domain, Email, Server]
...
# Fields may also be marked as read_only (and thus not editable) if they are not mass-assignable by current_user
  ...
  #   # Found associations:
  #   field :emails, :has_many_association
  #   field :servers, :has_and_belongs_to_many_association
  #   # Found columns:
  #   field :id, :integer
  #   field :name, :string
...
# Fields may also be marked as read_only (and thus not editable) if they are not mass-assignable by current_user
  ...
  #   # Found associations:
  #   field :domain, :belongs_to_association
  #   # Found columns:
  #   field :id, :integer
  #   field :address, :string
  #   field :domain_id, :integer        # Hidden
  #   field :first_name, :string
  #   field :last_name, :string
  #   field :quota, :integer
  #   field :maildir, :string
...
# Fields may also be marked as read_only (and thus not editable) if they are not mass-assignable by current_user
  ...
  #   # Found associations:
  #   field :domains, :has_and_belongs_to_many_association
  #   # Found columns:
  #   field :id, :integer
  #   field :server, :string
  #   field :description, :string
  #   field :server_type_id, :integer
